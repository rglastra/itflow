    ...
    <ul class="navbar-nav ml-auto">
        ...
        <form class="form-inline" action="/agent/global_search.php">
            <div class="input-group input-group-sm">
                <input class="form-control form-control-navbar" type="search" placeholder="<?php echo __('search_everywhere'); ?>" name="query"
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-footer">
                    <?php if ($session_is_admin) { ?>
                        <a href="/admin" class="btn btn-default btn-block btn-flat mb-2"><i class="fas fa-user-shield mr-2"></i><?php echo __('administration'); ?></a>
                    <?php } ?>
                    <a href="/agent/user/user_details.php" class="btn btn-default btn-flat"><i class="fas fa-user-cog mr-2"></i><?php echo __('account'); ?></a>
                    <a href="/agent/post.php?logout" class="btn btn-default btn-flat float-right"><i class="fas fa-sign-out-alt mr-2"></i><?php echo __('logout'); ?></a>
                </li>
            </ul>
        </li>
