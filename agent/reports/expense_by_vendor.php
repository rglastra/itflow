...
<div class="card card-dark">
    <div class="card-header py-2">
        <h3 class="card-title mt-2"><i class="fas fa-fw fa-building mr-2"></i><?php echo __('expense_by_vendor'); ?> <small><?php echo __('with_expense_amounts_600_or_more'); ?></small></h3>
