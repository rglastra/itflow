...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-tags mr-2"></i><?php echo sprintf(__('Assign Tags for %s Clients'), $count); ?></h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-footer">
        <button type="submit" name="bulk_assign_client_tags" class="btn btn-primary text-bold"><i class="fas fa-check mr-2"></i><?php echo __('Assign'); ?></button>
