...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-header bg-dark">
        <h5 class="modal-title"><i class="fa fa-fw fa-ethernet mr-2"></i><?php echo __('Bulk Set Interface Type'); ?></h5>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            <label><?php echo __('Interface Type'); ?></label>
    ...
    <div class="modal-footer">
        <button type="submit" name="bulk_edit_asset_interface_type" class="btn btn-primary text-bold"><i class="fas fa-check mr-2"></i><?php echo __('Set'); ?></button>
